...
public class ModernText3 extends JTextArea {
	private Font newFont;

	public ModernText3(String Text) {
		super(Text);
		setEditable(false);
		setOpaque(false);
		try {
			newFont = Font.createFont(Font.TRUETYPE_FONT, new File("Fonts/AbrilFatface.ttf")).deriveFont(10f);
